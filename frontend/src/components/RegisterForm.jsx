...
export default function RegisterForm() {
  ...
  const validate = () => {
    ...
    if (!personalEmailRegex.test(form.email)) return { field: 'email', message: 'Use a personal email (e.g. gmail, yahoo, outlook)' };
  ...
  const inputStyle = 'w-full p-3 border border-gray-500 rounded-lg bg-black text-white placeholder-gray-400';
